...
$jsonApp['info'] = [
    ...
    'ReceivedParams' => [
        'brand' => $post->brand,
        'audit_definition' => $post->audit_definition,
        'token' => $post->token,
        'lang' => $post->lang
    ]
];
...
$jsonApp['result']['REQUIRED_GENERAL_INFORMATION'] = [
    'requests' => [
        ['title' => 'Visit Status', 'title_esp' => translate_live($lang, 'Visit Status'), 'request_type'=>'SELECT_OPTIONS', 'required'=>true,
         'OPTIONS' => [
            ['title' => 'Visited', 'title_esp' => translate_live($lang, 'Visited'), 'requests'=>NULL],
            ['title' => 'Closed', 'title_esp' => translate_live($lang, 'Closed'), 'requests'=>[
...
foreach($rs as $r){
    ...
    $addi_questions[] = [
        ...
        'request_type' => $r['input_type'],
        'required' => true,
        'placeholder' => 'Here auditor comments...',
        'request_pictures' => false,
        'max_pictures' => 5,
        'request_notes1' => false,
        'request_notes2' => false,
        'OPTIONS' => $options
...
$jsonApp['result']['REQUIRED_ADDITIONAL_QUESTIONS']['requests'] = $addi_questions;
