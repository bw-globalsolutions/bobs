            ...
            <div class="tile-body">
              <form id="formRol" name="formRol">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="role_name" name="name" type="text" required>
                </div>
                <div class="form-group">
                  <label class="control-label" for="role_description"><?=$fnT('Description')?></label>
                  <textarea class="form-control" rows="2" id="role_description" name="description" required></textarea>
                </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="role_level" name="level" required>
