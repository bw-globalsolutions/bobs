        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form id="formPlanAction" class="form-horizontal">
                            ...
                            <div class="form-row justify-content-center">
                                <div class="form-group col-md-10">
                                    ...
                                    <textarea class="form-control valid validText" name="action" id="action" cols="40" rows="3" style="resize: both;" required></textarea>
                                </div>
                            ...
                            <div class="tile-footer">
                                <button id="btnFormAddAction" class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i><?=$fnT('Save')?></button>
