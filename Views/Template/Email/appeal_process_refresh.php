<?php $fnT = translate($data['lang']);?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<title><?=$fnT('Final appeal decision')?> </title>
</head>
<body>
                ...
                <td style='padding:5px;border:solid 1px #eeeeee;font-size:12px'>
                    <table width='100%' border='0' cellspacing='0' cellpadding='5' style='font-size:11px;font-family:Arial,Helvetica,sans-serif'>
                        <tbody>
                            ...
                            <tr>
                                <td style='text-align: center; padding:10px;background:#cf0a2c; color:#ffffff; font-size:15px'>
                                <span><?=$fnT('Final appeal decision')?> </span></td>
                            </tr>
                                ...
                                <td style='font-size:14px;padding:0px'>
                                    <div style='border:1px solid #eee;padding:11px'>
                                        <ul>
                                            ...
                                            <li><b><?=$fnT('Date of visit')?>: <?= date("F j, Y, h:m", strtotime( $data['date_visit'] )) ?></b></li>
                                        ...
                                        <div>
                                            <span><?=$fnT('You can also see the report at the following link')?>:</span> <b><a href="<?=$data['url_report']?>"><?=$data['url_report']?></a></b>
                            ...
                            <tr>
                                <td><b><?=$fnT('Create')?>:</b> <?=date('M d - h:i', time())?></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
