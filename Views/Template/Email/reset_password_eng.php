                        ...
                        <tbody>
                            <tr><td width='717'></td></tr>
	                            <tr><td style='padding:10px;background:#eab54c;color:#ffffff;font-size:11px'>
	                                <span>Informamos que você solicitou a redefinição de senha.</span>
	                            </td></tr>
                            ...
                            <tr>
                                <td style='font-size:14px;padding:0px'>
                                    <div style='border:1px solid #eee;padding:10px'>
                                        ...
                                        <div>
	                                            <span>Redefina sua senha aqui:</span> <b><a href='<?=base_url() . "/login/resetPassword?token=" . $data['token']?>'><?=base_url() . "/login/resetPassword?token=" . $data['token']?></a></b>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
	                                <td><b>Criado:</b> <?=date('M d - h:i', time())?>   /   <b>Validade:</b> 24 horas</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
