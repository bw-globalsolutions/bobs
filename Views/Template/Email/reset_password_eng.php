                    ...
                    <table width='100%' border='0' cellspacing='0' cellpadding='5' style='font-size:11px;font-family:Arial,Helvetica,sans-serif'>
                        <tbody>
                            ...
                            <tr><td style='padding:10px;background:#eab54c;color:#ffffff;font-size:11px'>
                                <span>We inform you that you have requested to reset your password.</span>
                            </td></tr>
                            ...
                            <tr>
                                <td style='font-size:14px;padding:0px'>
                                    <div style='border:1px solid #eee;padding:10px'>
                                        ...
                                        <div>
                                            <span>Reset your password here:</span> <b><a href='<?=base_url() . "/login/resetPassword?token=" . $data['token']?>'><?=base_url() . "/login/resetPassword?token=" . $data['token']?></a></b>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><b>Created:</b> <?=date('M d - h:i', time())?>   /   <b>Validity:</b> 24 hours</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
