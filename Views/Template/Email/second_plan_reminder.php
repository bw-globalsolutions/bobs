...
<head>
	...
	<title>Segundo Recordatorio del Plan de Acción</title>
</head>
<body>
                                ...
                                <td style='font-size:14px;padding:0px'>
                                    <div style='border:1px solid #eee;padding:10px'>
                                        <ul>
											...
											<li><b>Puntuación: <?=$data['score']?></b></li>
											<li><b>Oportunidades pendientes a completar: <?=$data['total_opps']?></b></li>
										</ul>
                                        <hr style='margin-top:20px;margin-bottom:20px;border:0;border-top:1px solid #eee'>
                                        <div>
                                            <span>Tiene <?= $data['limit_days'] ?> días para completar su plan de acción.</span><br>
                                            <span>Fecha límite: <?= date("F j, Y", strtotime( $data['date_limit'] )) ?></span>
                                        </div>
                                    </div>
                                </td>
                            </tr>
