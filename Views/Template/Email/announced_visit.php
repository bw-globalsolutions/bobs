                            ...
                            <tr>
                                <td style='font-size:14px;padding:0px'>
                                    <div style='border:1px solid #eee;padding:10px'>
                                        ...
                                        <div>
	                                            <span><?=(in_array($data['country'], [1,6])?"BOBS":"BOBS")?> decidiu fazer parceria com a Arguilea para realizar uma Avaliação Anunciada RAV. A visita RAV avalia as operações do restaurante e os padrões de Segurança dos alimentos.</span>
	                                        </div>
	                                        <div>
	                                            <p>O que esperar:</p>
	                                            <ul>
	                                                ...
	                                                <li>3. O Gerente Geral (RGM) deve estar presente nesta visita.</li>
	                                                ...
	                                                <li>7. O(a) especialista da Arguilea revisará os resultados da visita RAV com o Gerente Geral (RGM). Como esta é uma visita anunciada, o RGM receberá um plano de ação para revisar e tratar quaisquer constatações.</li>
	                                            </ul>
	                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <table align="center" class="table_store" style="width: 800px;">    
                                    <tr>
	                                        ...
	                                        <td style="background-color: rgba(211, 211, 211, 1); padding: 4px; font-weight: bold;">Data da visita</td>
