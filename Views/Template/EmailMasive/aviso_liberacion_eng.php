<?php
    function aviso_liberacion_eng($data){
        $mensaje = 
        "<!DOCTYPE html>
        <html lang='es'>
        <head>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='5' style='font-size:11px;font-family:Arial,Helvetica,sans-serif'>
                                <tbody>
                                    ...
                                    <tr><td style='padding:10px;background:#cf0a2c;color:#ffffff;font-size:11px'>
                                        <span>We inform you that the audit in question has been released in the system</span>
                                    </td></tr>
                                    <tr>
                                        <td style='font-size:14px;padding:0px'>
                                            <div style='border:1px solid #eee;padding:10px'>
                                                <span>Log in to the portal to view all the details and follow up on the Action Plan.</span>
                                                <ul>
                                                    <li><b>Location: {$data['location_number']}, {$data['location_address']}</b></li>
                                                    <li><b>Score: {$data['score']}</b></li>
                                                    <li><b>Result: {$data['result']}</b></li>
