<?php
    function aplan_reminder($data){
        ...
        <head>
            ...
            <title>{$fnT('Action Plan Reminder')}</title>
        </head>
        <body>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='5' style='font-size:11px;font-family:Arial,Helvetica,sans-serif'>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <span>{$fnT('Action Plan Reminder')}</span></td>
                                    </tr> 
                                    <tr>
                                        <td style='font-size:14px;padding:0px'>
                                            <div style='border:1px solid #eee;padding:10px'>
                                                <ul>
                                                    ...
                                                    <li><b>{$fnT('Pending opportunities to be completed')}: {$data['total_opps']}</b></li>
                                                </ul>
