<?php
    function new_user_notice_fn_esp($data){
        ...
        $mensaje = "<!DOCTYPE html>
                    <html lang='en'>
                        <head>
                            ...
                            <title>Nuevo acceso generado</title>
                        </head>
                        <body>
                                            ...
                                            <table width='100%' border='0' cellspacing='0' cellpadding='5' style='font-size:11px;font-family:Arial,Helvetica,sans-serif'>
                                                <tbody>
                                                    ...
                                                    <tr><td style='padding:10px;background:#eab54c;color:#ffffff;font-size:11px'>
                                                        <span>Le informamos que se ha generado un acceso a la plataforma de auditoría</span>
                                                    </td></tr>
                                                    ...
                                                    <tr>
                                                        <td style='font-size:14px;padding:0px'>
                                                            <div style='border:1px solid #eee;padding:10px'>
                                                                ...
                                                                <div>
                                                                    <span>Genera tu contraseña aquí:</span> <b><a href=' ".base_url() . "/login/resetPassword?token=" . $data['token']."'> ".base_url() . "/login/resetPassword?token=" . $data['token']."</a></b>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
