                                ...
                                <div class="mb-1">
                                    <div class="btn-group mb-1" role="group">
                                        <button type="button" class="btn btn-info btn-sm">
                                            <?=$fnT('Food safety')?>: <span id="score-critics"><?=$data['score']['FootSafety']?></span>
                                        </button>
                                        <button type="button" class="btn btn-info btn-sm">
                                            <?=$fnT('Brand Standards')?>: <span id="score-nocritics"><?=$data['score']['OperationsE']?></span>
                                        </button>
                                    </div><br>
                                    <div class="btn-group mb-1" role="group">
                                        ...
                                        <button type="button" style="background-color: var(--color5); color:var(--color4); border-radius:var(--radius); padding: 5px 15px; border:none;">
                                            <?=$fnT('Overall score')?>: <span id="score-yellow"><?=$data['score']['OverallScore']?></span>
                                        </button>
                    ...
                    <div class="row contTopOpA" id="report-panel">
                        ...
                        <div class="TOpA">
                            <a target="_blank" href="<?=$data['url_report']?>&download=1" class="TOpAbtn">
                                <i class="fa fa-download mb-1"></i><br><small class="menu-audit-item"><?=$fnT('Download report')?></small>
                            </a>
                        </div>
                ...
                <div class="row contTopOpA">
                    ...
                    <? if($data['status']=='In Process'): ?>
                        <div class="TOpA">
                            <a href="<?=base_url()?>/audits/times?id=<?=$id?>" class="OpAbtn <?=$sect=='Times'?'active':''?> <?=$isClosed?>">
                                <i class="fa fa-clock-o mb-1"></i><br><small class="menu-audit-item"><?=$fnT('Times')?></small>
                            </a>
                        </div>
                    <? endif ?>
                    ...
                    <div class="TOpA">
                        <a href="<?=base_url()?>/additional_Question?id=<?=$id?>" class="OpAbtn <?=$sect=='Informational questions'?'active':''?> <?=$isClosed?>">
                            <i class="fa fa-question mb-1" style="position:relative;left:13px;"></i><small class="menu-audit-item" style="text-align:center"><?=$fnT('Informational questions')?></small>
                        </a>
                    </div>
                    <? } ?>
