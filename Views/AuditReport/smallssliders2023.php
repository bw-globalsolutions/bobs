                    ...
                    <div class="col-lg-7">
                        <div class="card mb-3">
                            <div class="card-header hd-ss d-flex text-center">
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('AUTOMATIC FAIL')?></h6>
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('FOOD SAFETY')?></h6>
                                <h6 class="col"><?=$fnT('RESULT')?></h6>
                            </div>
                            ...
                            <? if($data['prev_scoring']): ?>
                                <div class="card-footer ">
                                    <?=$fnT('Previous score')?>:&nbsp;&nbsp; <b><?=$data['prev_scoring']['Calificacion']?></b> - <?=$fnT(getScoreDefinition($data['prev_scoring']['Calificacion'])[1])?>&nbsp;&nbsp; <b>(<?=$data['prev_scoring']['AutomaticFail'] + $data['prev_scoring']['FootSafety']?>pts)</b>
                                </div>
                            <? endif ?>
                        </div>
                        <? 
