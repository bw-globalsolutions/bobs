    ...
    <body class="bg-ss">
        <div class="container">
            <div class="d-flex justify-content-center mt-3 mb-1">
                <img class="img-fluid" src="https://carlsjrmx.netlify.app/assets/logo.svg" alt="Logo" id="img-main">
            </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card mb-3">
                            <div class="card-header hd-ss d-flex text-center">
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('Críticos')?></h6>
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('Maiores')?></h6>
                                <h6 class="col"><?=$fnT('Percentual')?></h6>
                            </div>
                            <div class="card-body d-flex p-2">
                                <div class="col d-none d-md-flex justify-content-center align-items-center"><b class="display-3"><?=$data['scoring']['Criticos']??0?></b><span>#</span></div>
                                <div class="col d-none d-md-flex justify-content-center align-items-center"><b class="display-3"><?=$data['scoring']['Mayores']??0?></b><span>#</span></div>
                                <div class="col d-none d-md-flex justify-content-center align-items-center"><b class="display-3"><?=round($data['scoring']['Porcentaje']??0, 0, PHP_ROUND_HALF_DOWN)?></b><span>%</span></div>
                            </div>
                            <div class="card-footer hd-ss text-center">
                                <?= $fnT('Pontuação') ?>: <b><?=$data['scoring']['Calificacion']??'NA'?></b>
                            </div>
                        </div>
                        <? 
