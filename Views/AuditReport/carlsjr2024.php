                    ...
                    <div class="col-lg-7">
                        <div class="card mb-3">
                            <div class="card-header hd-ss d-flex text-center">
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('Critics')?></h6>
                                <h6 class="col border-right d-none d-md-block"><?=$fnT('Majors')?></h6>
                                <h6 class="col"><?=$fnT('Percent')?></h6>
                            </div>
                            ...
                            <div class="card-footer hd-ss text-center">
                                <?= $fnT('Calification') ?>: <b><?=$data['scoring']['Calificacion']??'NA'?></b>
                            </div>
                        </div>
                        <? 
