    ...
    <body class="bg-ss">
        <div class="container">
            <div class="d-flex justify-content-center mt-3 mb-1">
                <img class="img-fluid" src="<?= media().'/images/logoDolphy.png' ?>" alt="Logo" id="img-main">
            </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card mb-3">
                            ...
                            <div class="card-body d-flex p-2">
                                ...
                                <div class="col d-none d-md-flex justify-content-center align-items-center"><b class="display-5"><?=$data['scoring']['Limpieza']??0?></b><span>#</span></div>
                                ...
                                <div class="card-body p-2">
                                    <table class="w-100 score" cellpadding="4">
                                        ...
                                        <tbody class="border-bottom">
                                            ...
                                            <? 
                                                if($s['section_name']!='Mantenimiento'){
